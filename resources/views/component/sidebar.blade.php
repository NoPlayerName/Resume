        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <a class="nav-link collapsed {{ Route::is('admin.profile.index') ? 'active' : '' }}" href="{{ route('admin.profile.index') }}">
                    ...
                    <a class="nav-link collapsed {{ Route::is('admin.resume.index') ? 'active' : '' }}" href="{{ route('admin.resume.index') }}">
